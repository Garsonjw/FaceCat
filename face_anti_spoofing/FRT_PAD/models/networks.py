...
from FRT_PAD.models.layers import IBasicBlock, ResidualBlock
from FRT_PAD.models.layers import GraphAttentionLayer
...
class PAD_Classifier(nn.Module):
    def __init__(self, PAE_net, downstream_net, target_net, downstream_name='FR'):
        ...
        self.classifier_layer = nn.Linear(1024, 1)
